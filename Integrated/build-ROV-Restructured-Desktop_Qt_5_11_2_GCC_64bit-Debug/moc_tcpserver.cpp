...
#include "../ROV-Restructured/tcpserver.h"
...
QT_MOC_LITERAL(7, 58, 4) // "read"

    },
    "TCPServer\0receivedmsg\0\0string\0reconnect\0"
    "connected\0sendmsg\0read"
};
...
void TCPServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->sendmsg((*reinterpret_cast< string(*)>(_a[1]))); break;
        ...
        {
            using _t = void (TCPServer::*)(string );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TCPServer::receivedmsg)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TCPServer::receivedmsg(string _t1)
{
